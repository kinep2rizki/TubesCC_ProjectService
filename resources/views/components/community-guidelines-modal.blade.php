<div x-show="showGuidelinesModal" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div x-show="showGuidelinesModal" x-transition.scale.origin.bottom class="relative transform overflow-hidden rounded-xl bg-surface-container-lowest border border-outline-variant/30 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-3xl flex flex-col max-h-[90vh] z-10">
        ...
        <div class="p-lg overflow-y-auto flex-1 flex flex-col gap-xl">
            ...
            <div class="space-y-sm">
                <h4 class="font-label-caps text-label-caps text-outline uppercase tracking-wider flex items-center gap-2">
                    <span class="material-symbols-outlined text-[16px]">article</span> Community Guidelines
                </h4>
                ...
                <div class="rounded-lg border border-outline-variant/40 bg-surface-container overflow-hidden focus-within:ring-1 focus-within:ring-primary focus-within:border-primary transition-shadow">
                    ...
                    <div class="bg-surface-container-high border-b border-outline-variant/30 px-sm py-1 flex gap-1">
                        <button class="p-1 rounded hover:bg-white/10 text-on-surface-variant transition-colors"><span class="material-symbols-outlined text-[18px]">format_bold</span></button>
                        <button class="p-1 rounded hover:bg-white/10 text-on-surface-variant transition-colors"><span class="material-symbols-outlined text-[18px]">format_italic</span></button>
                        <button class="p-1 rounded hover:bg-white/10 text-on-surface-variant transition-colors"><span class="material-symbols-outlined text-[18px]">format_list_bulleted</span></button>
                        <button class="p-1 rounded hover:bg-white/10 text-on-surface-variant transition-colors"><span class="material-symbols-outlined text-[18px]">format_list_numbered</span></button>
                        <div class="w-px h-6 bg-outline-variant/30 mx-1 my-auto"></div>
                        <button class="p-1 rounded hover:bg-white/10 text-on-surface-variant transition-colors"><span class="material-symbols-outlined text-[18px]">link</span></button>
                    </div>
                    <textarea class="w-full h-40 bg-transparent p-md text-on-surface focus:outline-none text-body-base resize-y" placeholder="1. Be respectful and welcoming...&#10;2. No spam or self-promotion..."></textarea>
                </div>
            </div>
            ...
            <div class="space-y-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                    <!-- Discord -->
                    <div class="flex items-center bg-surface-container-high border border-outline-variant/50 rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-primary focus-within:border-primary transition-shadow">
                        <div class="bg-surface-variant px-md py-sm flex items-center justify-center border-r border-outline-variant/50">
                            <span class="material-symbols-outlined text-primary">forum</span>
                        </div>
                        <input type="url" class="w-full bg-transparent px-md py-sm text-on-surface outline-none text-body-base" placeholder="https://discord.gg/...">
                    </div>
                    <!-- Twitter / X -->
                    <div class="flex items-center bg-surface-container-high border border-outline-variant/50 rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-primary focus-within:border-primary transition-shadow">
                        <div class="bg-surface-variant px-md py-sm flex items-center justify-center border-r border-outline-variant/50">
                        ...
                        <input type="url" class="w-full bg-transparent px-md py-sm text-on-surface outline-none text-body-base" placeholder="https://twitter.com/...">
                    </div>
                    <!-- GitHub -->
                    <div class="flex items-center bg-surface-container-high border border-outline-variant/50 rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-primary focus-within:border-primary transition-shadow">
                        <div class="bg-surface-variant px-md py-sm flex items-center justify-center border-r border-outline-variant/50">
                        ...
                        <input type="url" class="w-full bg-transparent px-md py-sm text-on-surface outline-none text-body-base" placeholder="https://github.com/...">
                    </div>
                    <!-- Website -->
                    <div class="flex items-center bg-surface-container-high border border-outline-variant/50 rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-primary focus-within:border-primary transition-shadow">
                        <div class="bg-surface-variant px-md py-sm flex items-center justify-center border-r border-outline-variant/50">
                        ...
                        <input type="url" class="w-full bg-transparent px-md py-sm text-on-surface outline-none text-body-base" placeholder="https://yoursite.com">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="px-lg py-md border-t border-outline-variant/20 flex justify-end gap-sm bg-surface-container-lowest/80">
            ...
            <button @click="showGuidelinesModal = false" type="button" class="flex items-center gap-xs px-4 py-2 rounded-lg bg-primary-container text-on-primary-container font-body-sm hover:bg-primary-fixed transition-colors shadow-[0_0_15px_rgba(77,142,255,0.2)]">
